data:extend({
  ...
  },
  {
    ...
    animation = make_rotated_animation_variations_from_sheet (3,
    {
      layers =
      {
        util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/remnant/tesla-turret-remnants",
        {
          line_length = 1,
          direction_count = 1,
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/remnant/tesla-turret-remnants-mask",
        {
          priority = "low",
          line_length = 1,
  ...
  },
  {
    ...
    animation = make_rotated_animation_variations_from_sheet (3,
    {
      layers =
      {
        util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/remnants/rocket-turret-remnants",
        {
          line_length = 1,
          direction_count = 1,
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/remnants/rocket-turret-remnants-mask",
        {
          priority = "low",
          line_length = 1,
          apply_runtime_tint = true,
  ...
  },
  {
    ...
    animation = make_rotated_animation_variations_from_sheet (3,
    {
      layers =
      {
        util.sprite_load("__base-age-plus__/graphics/entity/railgun-turret/remnants/railgun-turret-remnants",
        {
          line_length = 1,
          direction_count = 1,
          shift = util.by_pixel(0, 0),
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/railgun-turret/remnants/railgun-turret-remnants-mask",
        {
          priority = "low",
          line_length = 1,
          apply_runtime_tint = true,
  ...
  { 
    ...
    animation =
    {
      filename = "__base-age-plus__/graphics/entity/agricultural-tower/agricultural-tower-remnants.png",
      line_length = 1,
      width = 250,
      height = 250,
      frame_count = 1,
