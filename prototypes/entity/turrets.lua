  ...
  return
{
      layers =
      {
        util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-rising",
        {
          priority = "medium",
          direction_count = 4,
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-rising-glow",
        {
          priority = "medium",
          direction_count = 4,
          shift = util.by_pixel( 0.0, 0.0+rocket_turret_shift),
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-rising-mask",
        {
          flags = {"mask"},
          direction_count = 4,
          shift = util.by_pixel( 0.0, 0.0+rocket_turret_shift),
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-rising-shadow",
        {
          direction_count = 4,
          shift = util.by_pixel( 0.0, 0.0+rocket_turret_shift),
          scale = 0.5,
  ...
  return
{
  layers =
  {
    util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-shooting",
    {
      slice = 1,
      direction_count = 64,
      shift = util.by_pixel( 0.0, 0.0+rocket_turret_shift),
    ...
    util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-shooting-glow",
    {
      slice = 1,
      direction_count = 64,
      shift = util.by_pixel( 0.0, 0.0+rocket_turret_shift),
    ...
    util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-shooting-mask",
    {
      flags = {"mask"},
      apply_runtime_tint = true,
      slice = 1,
    ...
    util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-shooting-shadow",
    {
      draw_as_shadow = true,
      slice = 1,
      direction_count = 64,
...
function tesla_turret_rising(inputs)
  return
  {
    layers =
    {
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-rising",
      {
        priority = "medium",
        direction_count = 4,
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-rising-mask",
      {
        flags = {"mask"},
        apply_runtime_tint = true,
        priority = "medium",
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-rising-emit",
      {
        priority = "medium",
        direction_count = 4,
        shift = util.by_pixel(0,0+tesla_turret_shift),
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-rising-shadow",
      {
        draw_as_shadow = true,
        priority = "medium",
        direction_count = 4,
...
function tesla_turret_ready(inputs)
  return
  {
    layers =
    {
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-attacking",
      {
        direction_count = 64,
        frame_count = 1,
        repeat_count = 30,
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-attacking-mask",
      {
        flags = {"mask"},
        apply_runtime_tint = true,
        direction_count = 64,
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-attacking-emit",
      {
        direction_count = 64,
        frame_count = 1,
        repeat_count = 30,
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-attacking-shadow",
      {
        draw_as_shadow = true,
        direction_count = 64,
        frame_count = 1,
  ...
  function tesla_turret_cooldown(inputs)
    return
    {
      layers =
      {
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-head-attacking-facelight",
        {
          direction_count = 64,
          frame_count = 1,
          repeat_count = 30,
        ...
        util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-sfx-active",
        {
          direction_count = 1,
  ...
  function tesla_turret_LED(inputs)
    return
    {
      layers =
      {
        util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-LED",
        {
          direction_count = 1,
          duplicate_first_direction = true,
          shift = util.by_pixel(0,0+tesla_turret_shift),
...
data:extend({
  {
    ...
    graphics_set =
    {
      base_visualisation =
      {
        animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").base_picture
      }
    },
    preparing_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").neutral_animation,
    prepared_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").aiming_animation,
    starting_attack_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").warmup_animation,
    attacking_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").shooting_animation,
    ending_attack_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").cooldown_animation,
    folding_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").neutral_animation,
    folded_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").neutral_animation,
    resource_indicator_animation = require("__base-age-plus__.prototypes.entity.railgun-turret-pictures").resource_indicator_animation,
    special_effect =
    {
      type = "mask-by-circle",
      center =
    ...
    water_reflection =
    {
      pictures =
      {
        filename = "__base-age-plus__/graphics/entity/railgun-turret/railgun-reflection.png",
        priority = "extra-high",
        width = 40,
        height = 48,
  ...
  },
  {
    ...
    preparing_sound =
    {
      variations = sound_variations("__base-age-plus__/sound/entity/rocket-turret/rocket-turret-activate", 2, 0.4),
      aggregation = {max_count = 2, remove = true, count_already_playing = true},
    },
    folding_sound =
    {
      variations = sound_variations("__base-age-plus__/sound/entity/rocket-turret/rocket-turret-deactivate", 2, 0.5),
      aggregation = {max_count = 2, remove = true, count_already_playing = true},
    },
    rotating_sound =
    {
      sound =
      {
        variations = {filename = "__base-age-plus__/sound/entity/rocket-turret/rocket-turret-rotation-loop.ogg", volume = 0.15},
        aggregation = {max_count = 2, remove = true, count_already_playing = true},
      },
      stopped_sound =
      {
        variations = {filename = "__base-age-plus__/sound/entity/rocket-turret/rocket-turret-rotation-stop.ogg", volume = 0.5},
    ...
    graphics_set =
    {
      base_visualisation =
      {
        animation =
        {
          layers =
          {
            util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-base",
		    		              {
		    		                priority = "high",
                            frame_count = 1,
		    		                scale = 0.5,
            ...
            util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-base-mask",
		    		              {
            ...
            util.sprite_load("__base-age-plus__/graphics/entity/rocket-turret/rocket-turret-base-shadow",
		    		              {
		    		                frame_count = 1,
                            scale = 0.5,
		    		                shift = util.by_pixel( 0.0, 0.0+rocket_turret_shift),
    ...
    attack_parameters =
    {
      ...
      sound =
      {
        variations = sound_variations("__base-age-plus__/sound/ammo/rocket-turret-launcher", 7, 0.7, volume_multiplier("main-menu", 1.8)),
  ...
  },
  {
    ...
    working_sound =
    {
      sound = {filename = "__base-age-plus__/sound/entity/tesla-turret/tesla-turret-base.ogg", volume = 0.3},
    ...
    graphics_set =
    {
      ...
      {
        {
          animation =
          {
            layers =
            {
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-base",
                     {
                        frame_count = 1,
                        repeat_count=30,
                        shift = util.by_pixel(0, 0+tesla_turret_shift),
              ...
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-base-mask",
                     {
                        flags = {"mask"},
                        apply_runtime_tint = true,
                        frame_count = 1,
              ...
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-base-shadow",
                     {
                        frame_count = 1,
                        repeat_count=30,
                        draw_as_shadow = true,
              ...
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-base-emit",
                     {
                        frame_count = 1,
                        repeat_count=30,
                        shift = util.by_pixel(0, 0+tesla_turret_shift),
        ...
        },
        {
          ...
          animation =
          {
            layers =
            {
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-sfx-idle-2",
                      {
                        frame_count = 50,
                        repeat_count = 4,
                        shift = util.by_pixel(0, 0+tesla_turret_shift),
              ...
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-sfx-idle-1",
                      {
                        frame_count = 40,
                        repeat_count = 5,
                        shift = util.by_pixel(0, 0+tesla_turret_shift),
        ...
        },
        {
          ...
          animation  =
          {
            layers =
            {
              util.sprite_load("__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-sfx-passive",
              {
                 frame_count = 30,
                 shift = util.by_pixel(0, 0+tesla_turret_shift),
                 scale = 0.5,
      ...
      water_reflection = {
        pictures =
        {
          filename = "__base-age-plus__/graphics/entity/tesla-turret/tesla-turret-reflection.png",
          width = 26,
          height = 34,
