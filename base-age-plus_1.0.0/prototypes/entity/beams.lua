...
function get_beam_sprite(token)
  return
  {
      util.sprite_load("__base-age-plus__/graphics/entity/beam/tesla-body-"..token.."",
      {
        frame_count = 20,
        repeat_count = 4,
        draw_as_glow = true,
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/beam/lightning-loop-"..token.."",
      {
        frame_count = 80,
        draw_as_glow = true,
        animation_speed = 0.5,
...
function get_chain_sprite(token)
  return
  {
      util.sprite_load("__base-age-plus__/graphics/entity/beam/chain-body-0",
      {
        frame_count = 1,
        repeat_count = 40,
        draw_as_glow = true,
      ...
      util.sprite_load("__base-age-plus__/graphics/entity/beam/chain-body-"..token.."",
      {
        frame_count = 40,
        draw_as_glow = true,
        animation_speed = 0.5,
...
function make_tesla_electric_beam_graphics(blend_mode, beam_flags, beam_tint, light_tint, base_graphics_set)
  ...
  graphics_set.beam =
  {
    ...
    start = util.sprite_load("__base-age-plus__/graphics/entity/beam/tesla-beam-START",
    {
    ...
    ending = util.sprite_load("__base-age-plus__/graphics/entity/beam/tesla-beam-END",
    {
      flags = beam_flags or beam_non_light_flags,
      frame_count = 20,
      draw_as_glow = true,
    ...
    head = util.sprite_load("__base-age-plus__/graphics/entity/beam/tesla-head",
    {
      flags = beam_flags or beam_non_light_flags,
      frame_count = 20,
      draw_as_glow = true,
    ...
    tail = util.sprite_load("__base-age-plus__/graphics/entity/beam/tesla-tail",
    {
      flags = beam_flags or beam_non_light_flags,
      frame_count = 20,
      draw_as_glow = true,
...
function make_tesla_electric_beam_chain_graphics(blend_mode, beam_flags, beam_tint, light_tint, base_graphics_set)
  ...
  graphics_set.beam =
  {
    ...
    start = util.sprite_load("__base-age-plus__/graphics/entity/beam/chain-beam-START",
    {
      flags = beam_flags or beam_non_light_flags,
      frame_count = 20,
      draw_as_glow = true,
    ...
    ending = util.sprite_load("__base-age-plus__/graphics/entity/beam/chain-beam-END",
    {
      flags = beam_flags or beam_non_light_flags,
      frame_count = 20,
      draw_as_glow = true,
